...
const EditImovelConfirmation: React.FC<EditConfirmationProps> = ({
  entrevistado,
  imovel,
  destino,
  onEditSuccess,
    ...
    <>
      ...
      <Modal visible={isModalVisible} transparent animationType="slide">
        ...
        >
          ...
          >
            <Text type={textTypes.PARAGRAPH_LIGHT} color="#e42929">
            ...
            {loading ? (
              ...
              >
                <TouchableOpacity
                  ...
                  style={{ padding: 10 }}
                >
                  <Text type={textTypes.BUTTON_REGULAR} color="#888">
                    Cancelar
                  </Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  ...
                  style={{ padding: 10 }}
                >
                  <Text type={textTypes.BUTTON_REGULAR} color="#ff4500">
                    Confirmar
                  </Text>
                </TouchableOpacity>
              </View>
...
export default EditImovelConfirmation;